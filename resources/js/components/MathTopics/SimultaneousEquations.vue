...
<script>
import {FACT_SIMULTANEOUS_Q1, FACT_SIMULTANEOUS_Q2, FACT_SIMULTANEOUS_Q3, FACT_SIMULTANEOUS_Q4, FACT_SIMULTANEOUS_Q5} from '../../QuestionsAndSolutions/Mathematics/Factorisation/questions.js';
