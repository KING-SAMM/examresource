            ...
            <b-navbar-nav>
             ...
             <b-navbar-nav>
               <b-nav-item-dropdown text="Topics">
                <b-dropdown-item to="economics/topic1" exact exact-active-class="active">Topic1</b-dropdown-item>
                <b-dropdown-item to="economics/topic2" exact exact-active-class="active">topic2</b-dropdown-item>
                <b-dropdown-item to="economics/topic3" exact exact-active-class="active">topic3</b-dropdown-item>
                <b-dropdown-item to="economics/topic4" exact exact-active-class="active">Topic4</b-dropdown-item>
                <b-dropdown-item to="economics/topic5" exact exact-active-class="active">Topic5</b-dropdown-item>
                <b-dropdown-item to="economics/topic6" exact exact-active-class="active">Topic6</b-dropdown-item>
                <b-dropdown-item to="economics/topic7" exact exact-active-class="active">Topic7</b-dropdown-item>
                <b-dropdown-item to="economics/topic8" exact exact-active-class="active">Topic8</b-dropdown-item>
                <b-dropdown-item to="economics/topic9" exact exact-active-class="active">Topic9</b-dropdown-item>
              </b-nav-item-dropdown>
             </b-navbar-nav>
