...
<script>
import {MAT_ELASTICITY_Q1, MAT_ELASTICITY_Q2, MAT_ELASTICITY_Q3, MAT_ELASTICITY_Q4, MAT_ELASTICITY_Q5} from '../../Physics/Matter/questions.js';
import {GEO_COORD_SOL1, GEO_COORD_SOL2, GEO_COORD_SOL3, GEO_COORD_SOL4} from '../../Mathematics/Geometry/solutions.js';
  
  export default {
    data() {
      return {
        question1: MAT_ELASTICITY_Q1,
        question2: MAT_ELASTICITY_Q2,
        question3: MAT_ELASTICITY_Q3,
        question4: MAT_ELASTICITY_Q4,
        question5: MAT_ELASTICITY_Q5,
