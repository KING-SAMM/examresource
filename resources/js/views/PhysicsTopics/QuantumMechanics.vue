<template>
  <!-- <transition name="slide"> -->
    ...
    <h1>Photoelectricity, Energy Levels, X-Rays, Heisenberg's Uncertainty Principle Questions</h1>
...
<script>
import {QUANTUMMECHANICS_Q1, QUANTUMMECHANICS_Q2, QUANTUMMECHANICS_Q3, QUANTUMMECHANICS_Q4, QUANTUMMECHANICS_Q5} from '../../Physics/QuantumMechanics/questions.js';
import {GEO_COORD_SOL1, GEO_COORD_SOL2, GEO_COORD_SOL3, GEO_COORD_SOL4} from '../../Mathematics/Geometry/solutions.js';
  
  export default {
    data() {
      return {
        question1: QUANTUMMECHANICS_Q1,
        question2: QUANTUMMECHANICS_Q2,
        question3: QUANTUMMECHANICS_Q3,
        question4: QUANTUMMECHANICS_Q4,
        question5: QUANTUMMECHANICS_Q5,
