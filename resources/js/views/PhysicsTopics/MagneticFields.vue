<template>
  <!-- <transition name="slide"> -->
    ...
    <h1>Magnets and Magnetic Fields Questions</h1>
...
<script>
import {MAG_MAGNETIC_FIELDS_Q1, MAG_MAGNETIC_FIELDS_Q2, MAG_MAGNETIC_FIELDS_Q3, MAG_MAGNETIC_FIELDS_Q4, MAG_MAGNETIC_FIELDS_Q5} from '../../Physics/Fields/questions.js';
import {GEO_COORD_SOL1, GEO_COORD_SOL2, GEO_COORD_SOL3, GEO_COORD_SOL4} from '../../Mathematics/Geometry/solutions.js';
  
  export default {
    data() {
      return {
        question1: MAG_MAGNETIC_FIELDS_Q1,
        question2: MAG_MAGNETIC_FIELDS_Q2,
        question3: MAG_MAGNETIC_FIELDS_Q3,
        question4: MAG_MAGNETIC_FIELDS_Q4,
        question5: MAG_MAGNETIC_FIELDS_Q5,
