<template>
  <!-- <transition name="slide"> -->
    ...
    <h1>Electrostatics Questions</h1>
...
<script>
import {ELECT_ELECTROSTATICS_Q1, ELECT_ELECTROSTATICS_Q2, ELECT_ELECTROSTATICS_Q3, ELECT_ELECTROSTATICS_Q4, ELECT_ELECTROSTATICS_Q5} from '../../Physics/Electricity/questions.js';
import {GEO_COORD_SOL1, GEO_COORD_SOL2, GEO_COORD_SOL3, GEO_COORD_SOL4} from '../../Mathematics/Geometry/solutions.js';
  
  export default {
    data() {
      return {
        question1: ELECT_ELECTROSTATICS_Q1,
        question2: ELECT_ELECTROSTATICS_Q2,
        question3: ELECT_ELECTROSTATICS_Q3,
        question4: ELECT_ELECTROSTATICS_Q4,
        question5: ELECT_ELECTROSTATICS_Q5,
