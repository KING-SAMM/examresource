<template>
  <!-- <transition name="slide"> -->
    ...
    <h1>Nuclear Energy and Radioactivity Questions</h1>
...
<script>
import {RADIOACTIVITY_Q1, RADIOACTIVITY_Q2, RADIOACTIVITY_Q3, RADIOACTIVITY_Q4, RADIOACTIVITY_Q5} from '../../Physics/NuclearEnergy/questions.js';
import {GEO_COORD_SOL1, GEO_COORD_SOL2, GEO_COORD_SOL3, GEO_COORD_SOL4} from '../../Mathematics/Geometry/solutions.js';
  
  export default {
    data() {
      return {
        question1: RADIOACTIVITY_Q1,
        question2: RADIOACTIVITY_Q2,
        question3: RADIOACTIVITY_Q3,
        question4: RADIOACTIVITY_Q4,
        question5: RADIOACTIVITY_Q5,
