<template>
  <!-- <transition name="slide"> -->
    ...
    <h1>Circular Motion Questions</h1>
...
<script>
import {MOT_CIRCULAR_Q1, MOT_CIRCULAR_Q2, MOT_CIRCULAR_Q3, MOT_CIRCULAR_Q4, MOT_CIRCULAR_Q5} from '../../Physics/Motion/questions.js';
import {GEO_COORD_SOL1, GEO_COORD_SOL2, GEO_COORD_SOL3, GEO_COORD_SOL4} from '../../Mathematics/Geometry/solutions.js';
  
  export default {
    data() {
      return {
        question1: MOT_CIRCULAR_Q1,
        question2: MOT_CIRCULAR_Q2,
        question3: MOT_CIRCULAR_Q3,
        question4: MOT_CIRCULAR_Q4,
        question5: MOT_CIRCULAR_Q5,
