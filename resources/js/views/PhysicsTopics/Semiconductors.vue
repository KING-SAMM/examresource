<template>
  <!-- <transition name="slide"> -->
    ...
    <h1>Semiconductors Questions</h1>
...
<script>
import {BE_SEMICONDUCTORS_Q1, BE_SEMICONDUCTORS_Q2, BE_SEMICONDUCTORS_Q3, BE_SEMICONDUCTORS_Q4, BE_SEMICONDUCTORS_Q5} from '../../Physics/BasicElectronics/questions.js';
import {GEO_COORD_SOL1, GEO_COORD_SOL2, GEO_COORD_SOL3, GEO_COORD_SOL4} from '../../Mathematics/Geometry/solutions.js';
  
  export default {
    data() {
      return {
        question1: BE_SEMICONDUCTORS_Q1,
        question2: BE_SEMICONDUCTORS_Q2,
        question3: BE_SEMICONDUCTORS_Q3,
        question4: BE_SEMICONDUCTORS_Q4,
        question5: BE_SEMICONDUCTORS_Q5,
