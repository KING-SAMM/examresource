<template>
  <!-- <transition name="slide"> -->
    ...
    <h1>Fundamental/Derived Quantities/Units and Dimensional Analysis Questions</h1>
...
<script>
import {MEA_DIMENSIONS_Q1, MEA_DIMENSIONS_Q2, MEA_DIMENSIONS_Q3, MEA_DIMENSIONS_Q4, MEA_DIMENSIONS_Q5} from '../../Physics/Measurements/questions.js';
import {GEO_COORD_SOL1, GEO_COORD_SOL2, GEO_COORD_SOL3, GEO_COORD_SOL4} from '../../Mathematics/Geometry/solutions.js';
  
  export default {
    data() {
      return {
        question1: MEA_DIMENSIONS_Q1,
        question2: MEA_DIMENSIONS_Q2,
        question3: MEA_DIMENSIONS_Q3,
        question4: MEA_DIMENSIONS_Q4,
        question5: MEA_DIMENSIONS_Q5,
