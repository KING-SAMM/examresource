...
<script>
import {HEAT_HEAT_Q1, HEAT_HEAT_Q2, HEAT_HEAT_Q3, HEAT_HEAT_Q4, HEAT_HEAT_Q5} from '../../Physics/HeatEnergy/questions.js';
import {GEO_COORD_SOL1, GEO_COORD_SOL2, GEO_COORD_SOL3, GEO_COORD_SOL4} from '../../Mathematics/Geometry/solutions.js';
  
  export default {
    data() {
      return {
        question1: HEAT_HEAT_Q1,
        question2: HEAT_HEAT_Q2,
        question3: HEAT_HEAT_Q3,
        question4: HEAT_HEAT_Q4,
        question5: HEAT_HEAT_Q5,
