<template>
  <!-- <transition name="slide"> -->
    ...
    <h1>Electromagnetic Induction Questions</h1>
...
<script>
import {MAG_ELECTROMAG_INDUCTION_Q1, MAG_ELECTROMAG_INDUCTION_Q2, MAG_ELECTROMAG_INDUCTION_Q3, MAG_ELECTROMAG_INDUCTION_Q4, MAG_ELECTROMAG_INDUCTION_Q5} from '../../Physics/Fields/questions.js';
import {GEO_COORD_SOL1, GEO_COORD_SOL2, GEO_COORD_SOL3, GEO_COORD_SOL4} from '../../Mathematics/Geometry/solutions.js';
  
  export default {
    data() {
      return {
        question1: MAG_ELECTROMAG_INDUCTION_Q1,
        question2: MAG_ELECTROMAG_INDUCTION_Q2,
        question3: MAG_ELECTROMAG_INDUCTION_Q3,
        question4: MAG_ELECTROMAG_INDUCTION_Q4,
        question5: MAG_ELECTROMAG_INDUCTION_Q5,
