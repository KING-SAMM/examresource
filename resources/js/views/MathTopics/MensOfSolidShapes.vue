<template>
  <!-- <transition name="slide"> -->
    ...
    <h1>Mensuration of Solid Shapes Questions</h1>
...
<script>
import {MEN_SOLID_Q1, MEN_SOLID_Q2, MEN_SOLID_Q3, MEN_SOLID_Q4, MEN_SOLID_Q5} from '../../Mathematics/Mensuration/questions.js';
import {GEO_COORD_SOL1, GEO_COORD_SOL2, GEO_COORD_SOL3, GEO_COORD_SOL4} from '../../Mathematics/Geometry/solutions.js';
  
  export default {
    data() {
      return {
        question1: MEN_SOLID_Q1,
        question2: MEN_SOLID_Q2,
        question3: MEN_SOLID_Q3,
        question4: MEN_SOLID_Q4,
        question5: MEN_SOLID_Q5,
