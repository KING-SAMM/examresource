<template>
  <!-- <transition name="slide"> -->
    ...
    <h1>Quadratic Equations Questions</h1>
...
<script>
import {FACT_QUADRATIC_Q1, FACT_QUADRATIC_Q2, FACT_QUADRATIC_Q3, FACT_QUADRATIC_Q4, FACT_QUADRATIC_Q5} from '../../Mathematics/Factorisation/questions.js';
import {GEO_COORD_SOL1, GEO_COORD_SOL2, GEO_COORD_SOL3, GEO_COORD_SOL4} from '../../Mathematics/Geometry/solutions.js';
  
  export default {
    data() {
      return {
        question1: FACT_QUADRATIC_Q1,
        question2: FACT_QUADRATIC_Q2,
        question3: FACT_QUADRATIC_Q3,
        question4: FACT_QUADRATIC_Q4,
        question5: FACT_QUADRATIC_Q5,
