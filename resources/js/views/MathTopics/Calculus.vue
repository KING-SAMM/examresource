  ...
  <!-- <transition name="slide"> -->
    ...
    <div role="tablist">
        ...
        <b-collapse id="accordion-1" visible accordion="my-accordion" role="tabpanel">
            ...
            <b-card-text><b-img :src="require('../../Mathematics/Calculus/CAL_DIFF_Q1_90.png')"></b-img></b-card-text>
        ...
        <b-collapse id="accordion-2" accordion="my-accordion" role="tabpanel">
            <b-card-body>
            <b-card-text><b-img :src="require('../../Mathematics/Calculus/CAL_DIFF_Q2_90.png')"></b-img></b-card-text>
            <b-card-text><b-button variant="info" v-b-toggle.short>Short solution</b-button><b-button variant="info" v-b-toggle.full>Full solution</b-button><b-button variant="warning" v-b-toggle.answer>Answer</b-button></b-card-text>
            <b-collapse id="answer">
        ...
        <b-collapse id="accordion-5" accordion="my-accordion" role="tabpanel">
         ...
         <b-card no-body class="mb-1">
        <b-card-header header-tag="header" class="p-1" role="tab">
            <b-button block href="#" v-b-toggle.accordion-6 variant="info">Question 6</b-button>
        </b-card-header>
        <b-collapse id="accordion-6" accordion="my-accordion" role="tabpanel">
            <b-card-body>
            <b-card-text>{{ question6 }}</b-card-text>
            <b-card-text><b-button variant="info" v-b-toggle.short>Short solution</b-button><b-button variant="info" v-b-toggle.full>Full solution</b-button><b-button variant="warning" v-b-toggle.answer>Answer</b-button></b-card-text>
             <b-collapse id="answer">
              <b-img :src="require('../../Mathematics/Geometry/GEO_COORD_ANS3_COPY_80.png')"></b-img>
            </b-collapse>
         ...
         <b-card no-body class="mb-1">
        <b-card-header header-tag="header" class="p-1" role="tab">
            <b-button block href="#" v-b-toggle.accordion-7 variant="info">Question 7</b-button>
        </b-card-header>
        <b-collapse id="accordion-7" accordion="my-accordion" role="tabpanel">
            <b-card-body>
            <b-card-text>{{ question7 }}</b-card-text>
            <b-card-text><b-button variant="info" v-b-toggle.short>Short solution</b-button><b-button variant="info" v-b-toggle.full>Full solution</b-button><b-button variant="warning" v-b-toggle.answer>Answer</b-button></b-card-text>
             <b-collapse id="answer">
              <b-img :src="require('../../Mathematics/Geometry/GEO_COORD_ANS3_COPY_80.png')"></b-img>
            </b-collapse>
         ...
         <b-card no-body class="mb-1">
        <b-card-header header-tag="header" class="p-1" role="tab">
            <b-button block href="#" v-b-toggle.accordion-8 variant="info">Question 8</b-button>
        </b-card-header>
        <b-collapse id="accordion-8" accordion="my-accordion" role="tabpanel">
            <b-card-body>
            <b-card-text>{{ question8 }}</b-card-text>
            <b-card-text><b-button variant="info" v-b-toggle.short>Short solution</b-button><b-button variant="info" v-b-toggle.full>Full solution</b-button><b-button variant="warning" v-b-toggle.answer>Answer</b-button></b-card-text>
             <b-collapse id="answer">
              <b-img :src="require('../../Mathematics/Geometry/GEO_COORD_ANS3_COPY_80.png')"></b-img>
            </b-collapse>
        ...
        <b-card no-body class="mb-1">
        <b-card-header header-tag="header" class="p-1" role="tab">
            <b-button block href="#" v-b-toggle.accordion-9 variant="info">Question 9</b-button>
        </b-card-header>
        <b-collapse id="accordion-9" accordion="my-accordion" role="tabpanel">
            <b-card-body>
            <b-card-text>{{ question9 }}</b-card-text>
            <b-card-text><b-button variant="info" v-b-toggle.short>Short solution</b-button><b-button variant="info" v-b-toggle.full>Full solution</b-button><b-button variant="warning" v-b-toggle.answer>Answer</b-button></b-card-text>
             <b-collapse id="answer">
              <b-img :src="require('../../Mathematics/Geometry/GEO_COORD_ANS3_COPY_80.png')"></b-img>
            </b-collapse>
        ...
        <b-card no-body class="mb-1">
        <b-card-header header-tag="header" class="p-1" role="tab">
            <b-button block href="#" v-b-toggle.accordion-10 variant="info">Question 8</b-button>
        </b-card-header>
        <b-collapse id="accordion-10" accordion="my-accordion" role="tabpanel">
            <b-card-body>
            <b-card-text>{{ question10 }}</b-card-text>
            <b-card-text><b-button variant="info" v-b-toggle.short>Short solution</b-button><b-button variant="info" v-b-toggle.full>Full solution</b-button><b-button variant="warning" v-b-toggle.answer>Answer</b-button></b-card-text>
             <b-collapse id="answer">
              <b-img :src="require('../../Mathematics/Geometry/GEO_COORD_ANS3_COPY_80.png')"></b-img>
            </b-collapse>
...
<script>
import {CAL_DIFF_Q1, CAL_DIFF_Q2, CAL_DIFF_Q3, CAL_DIFF_Q4, CAL_DIFF_Q5} from '../../Mathematics/Calculus/questions.js';
import {CAL_INTEG_Q1, CAL_INTEG_Q2, CAL_INTEG_Q3, CAL_INTEG_Q4, CAL_INTEG_Q5} from '../../Mathematics/Calculus/questions.js';
import {GEO_COORD_SOL1, GEO_COORD_SOL2, GEO_COORD_SOL3, GEO_COORD_SOL4} from '../../Mathematics/Geometry/solutions.js';
  
  export default {
    data() {
      return {
        question1: CAL_DIFF_Q1,
        question2: CAL_DIFF_Q2,
        question3: CAL_DIFF_Q3,
        question4: CAL_DIFF_Q4,
        question5: CAL_DIFF_Q5,
        question6: CAL_INTEG_Q1,
        question7: CAL_INTEG_Q2,
        question8: CAL_INTEG_Q3,
        question9: CAL_INTEG_Q4,
        question10: CAL_INTEG_Q5,
