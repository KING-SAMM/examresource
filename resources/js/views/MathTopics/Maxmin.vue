<template>
  <!-- <transition name="slide"> -->
    ...
    <h1>Maxima and Minima Questions</h1>
...
<script>
import {CAL_MAXMIN_Q1, CAL_MAXMIN_Q2, CAL_MAXMIN_Q3, CAL_MAXMIN_Q4, CAL_MAXMIN_Q5} from '../../Mathematics/Calculus/questions.js';
import {GEO_COORD_SOL1, GEO_COORD_SOL2, GEO_COORD_SOL3, GEO_COORD_SOL4} from '../../Mathematics/Geometry/solutions.js';
  
  export default {
    data() {
      return {
        question1: CAL_MAXMIN_Q1,
        question2: CAL_MAXMIN_Q2,
        question3: CAL_MAXMIN_Q3,
        question4: CAL_MAXMIN_Q4,
        question5: CAL_MAXMIN_Q5,
