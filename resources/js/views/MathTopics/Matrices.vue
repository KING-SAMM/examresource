<template>
  <!-- <transition name="slide"> -->
    ...
    <h1>Matrices and Determinants Questions</h1>
...
<script>
import {MAT_MATRICES_Q1, MAT_MATRICES_Q2, MAT_MATRICES_Q3, MAT_MATRICES_Q4, MAT_MATRICES_Q5} from '../../Mathematics/Matrices/questions.js';
import {GEO_COORD_SOL1, GEO_COORD_SOL2, GEO_COORD_SOL3, GEO_COORD_SOL4} from '../../Mathematics/Geometry/solutions.js';
  
  export default {
    data() {
      return {
        question1: MAT_MATRICES_Q1,
        question2: MAT_MATRICES_Q2,
        question3: MAT_MATRICES_Q3,
        question4: MAT_MATRICES_Q4,
        question5: MAT_MATRICES_Q5,
