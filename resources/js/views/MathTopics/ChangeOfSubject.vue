<template>
  <!-- <transition name="slide"> -->
    ...
    <h1>Change of Subject of Formula Questions</h1>
...
<script>
import {PRO_CHANGE_OF_SUBJECT_Q1, PRO_CHANGE_OF_SUBJECT_Q2, PRO_CHANGE_OF_SUBJECT_Q3, PRO_CHANGE_OF_SUBJECT_Q4, PRO_CHANGE_OF_SUBJECT_Q5} from '../../Mathematics/Progression/questions.js';
import {GEO_COORD_SOL1, GEO_COORD_SOL2, GEO_COORD_SOL3, GEO_COORD_SOL4} from '../../Mathematics/Geometry/solutions.js';
  
  export default {
    data() {
      return {
        question1: PRO_CHANGE_OF_SUBJECT_Q1,
        question2: PRO_CHANGE_OF_SUBJECT_Q2,
        question3: PRO_CHANGE_OF_SUBJECT_Q3,
        question4: PRO_CHANGE_OF_SUBJECT_Q4,
        question5: PRO_CHANGE_OF_SUBJECT_Q5,
