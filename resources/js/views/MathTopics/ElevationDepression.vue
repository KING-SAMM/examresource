<template>
  <!-- <transition name="slide"> -->
    ...
    <h1>Angles of Elevation and Depression Questions</h1>
...
<script>
import {ANG_ELEVATION_DEPRESSION_Q1, ANG_ELEVATION_DEPRESSION_Q2, ANG_ELEVATION_DEPRESSION_Q3, ANG_ELEVATION_DEPRESSION_Q4, ANG_ELEVATION_DEPRESSION_Q5} from '../../Mathematics/Angles/questions.js';
import {GEO_COORD_SOL1, GEO_COORD_SOL2, GEO_COORD_SOL3, GEO_COORD_SOL4} from '../../Mathematics/Geometry/solutions.js';
  
  export default {
    data() {
      return {
        question1: ANG_ELEVATION_DEPRESSION_Q1,
        question2: ANG_ELEVATION_DEPRESSION_Q2,
        question3: ANG_ELEVATION_DEPRESSION_Q3,
        question4: ANG_ELEVATION_DEPRESSION_Q4,
        question5: ANG_ELEVATION_DEPRESSION_Q5,
