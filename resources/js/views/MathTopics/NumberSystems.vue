<template>
  <!-- <transition name="slide"> -->
    ...
    <h1>Number Systems Questions</h1>
...
<script>
import {BIN_NUMBERSYSTMS_Q1, BIN_NUMBERSYSTMS_Q2, BIN_NUMBERSYSTMS_Q3, BIN_NUMBERSYSTMS_Q4, BIN_NUMBERSYSTMS_Q5} from '../../Mathematics/BinaryOperations/questions.js';
import {GEO_COORD_SOL1, GEO_COORD_SOL2, GEO_COORD_SOL3, GEO_COORD_SOL4} from '../../Mathematics/Geometry/solutions.js';
  
  export default {
    data() {
      return {
        question1: BIN_NUMBERSYSTMS_Q1,
        question2: BIN_NUMBERSYSTMS_Q2,
        question3: BIN_NUMBERSYSTMS_Q3,
        question4: BIN_NUMBERSYSTMS_Q4,
        question5: BIN_NUMBERSYSTMS_Q5,
