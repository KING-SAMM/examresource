...
<script>
import {FACT_POLYNOMIALS_Q1, FACT_POLYNOMIALS_Q2, FACT_POLYNOMIALS_Q3, FACT_POLYNOMIALS_Q4, FACT_POLYNOMIALS_Q5} from '../../Mathematics/Factorisation/questions.js';
import {GEO_COORD_SOL1, GEO_COORD_SOL2, GEO_COORD_SOL3, GEO_COORD_SOL4} from '../../Mathematics/Geometry/solutions.js';
  
  export default {
    data() {
      return {
        question1: FACT_POLYNOMIALS_Q1,
        question2: FACT_POLYNOMIALS_Q2,
        question3: FACT_POLYNOMIALS_Q3,
        question4: FACT_POLYNOMIALS_Q4,
        question5: FACT_POLYNOMIALS_Q5,
