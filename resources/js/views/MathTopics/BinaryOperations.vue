<template>
  <!-- <transition name="slide"> -->
    ...
    <h1>Binary Operations Questions</h1>
...
<script>
import {BIN_BINARYOPS_Q1, BIN_BINARYOPS_Q2, BIN_BINARYOPS_Q3, BIN_BINARYOPS_Q4, BIN_BINARYOPS_Q5} from '../../Mathematics/BinaryOperations/questions.js';
import {GEO_COORD_SOL1, GEO_COORD_SOL2, GEO_COORD_SOL3, GEO_COORD_SOL4} from '../../Mathematics/Geometry/solutions.js';
  
  export default {
    data() {
      return {
        question1: BIN_BINARYOPS_Q1,
        question2: BIN_BINARYOPS_Q2,
        question3: BIN_BINARYOPS_Q3,
        question4: BIN_BINARYOPS_Q4,
        question5: BIN_BINARYOPS_Q5,
