...
<script>
import {ANG_TRIGONOMETRY_Q1, ANG_TRIGONOMETRY_Q2, ANG_TRIGONOMETRY_Q3, ANG_TRIGONOMETRY_Q4, ANG_TRIGONOMETRY_Q5} from '../../Mathematics/Angles/questions.js';
import {GEO_COORD_SOL1, GEO_COORD_SOL2, GEO_COORD_SOL3, GEO_COORD_SOL4} from '../../Mathematics/Geometry/solutions.js';
  
  export default {
    data() {
      return {
        question1: ANG_TRIGONOMETRY_Q1,
        question2: ANG_TRIGONOMETRY_Q2,
        question3: ANG_TRIGONOMETRY_Q3,
        question4: ANG_TRIGONOMETRY_Q4,
        question5: ANG_TRIGONOMETRY_Q5,
