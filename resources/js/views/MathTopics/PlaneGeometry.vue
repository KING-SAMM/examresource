<template>
  <!-- <transition name="slide"> -->
    ...
    <h1>Plane Geometry Questions</h1>
...
<script>
import {GEO_PLANE_Q1, GEO_PLANE_Q2, GEO_PLANE_Q3, GEO_PLANE_Q4, GEO_PLANE_Q5} from '../../Mathematics/Geometry/questions.js';
import {GEO_COORD_SOL1, GEO_COORD_SOL2, GEO_COORD_SOL3, GEO_COORD_SOL4} from '../../Mathematics/Geometry/solutions.js';
  
  export default {
    data() {
      return {
        question1: GEO_PLANE_Q1,
        question2: GEO_PLANE_Q2,
        question3: GEO_PLANE_Q3,
        question4: GEO_PLANE_Q4,
        question5: GEO_PLANE_Q5,
