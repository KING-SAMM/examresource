...
<script>
import {STA_PROBABILITY_Q1, STA_PROBABILITY_Q2, STA_PROBABILITY_Q3, STA_PROBABILITY_Q4, STA_PROBABILITY_Q5} from '../../Mathematics/Statistics/questions.js';
import {GEO_COORD_SOL1, GEO_COORD_SOL2, GEO_COORD_SOL3, GEO_COORD_SOL4} from '../../Mathematics/Geometry/solutions.js';
  
  export default {
    data() {
      return {
        question1: STA_PROBABILITY_Q1,
        question2: STA_PROBABILITY_Q2,
        question3: STA_PROBABILITY_Q3,
        question4: STA_PROBABILITY_Q4,
        question5: STA_PROBABILITY_Q5,
